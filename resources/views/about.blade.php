            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="about-text">
                        ...
                        <h2 style="color: #AD8E00;">THE FIRM</h2>
                        <p>
                            At Leam Legal Practice, we are built on a foundation of excellence, integrity, and results.
                            As a full-service law firm, we provide cutting-edge legal solutions tailored to the needs of
                            individuals, businesses, and organizations. With a team of highly skilled and experienced lawyers, 
                            we navigate complex legal landscapes with precision and diligence, By combining legal expertise, industry knowledge,
                            and innovative strategies, we provide proactive support and effective
                            representation—whether you're a business navigating corporate laws, an
                            individual seeking legal protection, or an organization requiring compliance
                            guidance. Committed to clarity, confidence, and results, we ensure that your
