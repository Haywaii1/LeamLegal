...
class ProfileController extends Controller
{
    public function show($name)
    {
        ...
        $teamMembers = [
            ...
            'morisola' => ['name' => 'Morisola Alaba Akinlabi', 'role' => 'Partner', 'image' => 'img/moji.jpg', 'bio' => 'Morisola Alaba Akinlabi is a dedicated legal practitioner with extensive experience in legal research, litigation at both national and regional levels, legislative advocacy, and capacity-building initiatives. Her expertise spans human rights law, with a particular focus on freedom of expression, access to information, media freedom, and digital rights.
            ...
            'waliu' => ['name' => 'Waliu Abiodun Bello', 'role' => 'Partner', 'image' => 'img/waliu.jpg', 'bio' => 'Waliu Abiodun Bello is a skilled legal professional at Leam Legal Practice, offering tailored legal solutions across corporate and commercial law, dispute resolution, regulatory compliance, and real estate transactions. He provides sound legal advice and representation, helping clients navigate complex legal and business challenges with efficiency and precision.
